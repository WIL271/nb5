        ...
        <form class="formula" action="form.php" method="POST">
            ...
            <label>
                ...
                <select name="ability[]"
                    ...
                    <option value="0" <?php echo (in_array("0",$ability)) ?  "selected" : ""  ; ?>>Бессмертие</option>
                    <option value="1" <?php echo (in_array('1',$ability)) ?  "selected" : ""  ; ?>>Прохождение сквозь стены</option>
                    <option value="2" <?php echo (in_array('2',$ability)) ?  "selected" : ""  ; ?>>Левитация</option>
                </select>
            </label><br />
